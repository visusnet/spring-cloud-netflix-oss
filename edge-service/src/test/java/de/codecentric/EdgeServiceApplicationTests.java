...
public class EdgeServiceApplicationTests {
	...
	@Test
	public void zuulProxyShouldBeConfigured() {
		assertApplicationClassHasAnnotation("EnableZuulProxy");
	}
	...
	private void assertApplicationClassHasAnnotation(String annotationName) {
		Optional<Annotation> optionalAnnotation = Arrays.stream(EdgeServiceApplication.class.getAnnotations())
