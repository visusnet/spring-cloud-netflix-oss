...
public class DiscoveryServiceApplicationTests {
	...
	@Test
	public void discoveryServerShouldBeConfigured() {
		assertApplicationClassHasAnnotation("EnableEurekaServer");
	}
	...
	private void assertApplicationClassHasAnnotation(String annotationName) {
		Optional<Annotation> optionalAnnotation = Arrays.stream(DiscoveryServiceApplication.class.getAnnotations())
